...
export default function HackingDetectedPage() {
  ...
  return (
    <div className="fixed inset-0 z-[9998] flex flex-col items-center justify-center bg-gray-950 px-4">
      ...
      <h1 className="mt-4 text-2xl font-bold text-white text-center">Suspicious Activity Blocked</h1>
      <p className="mt-2 text-gray-400 text-center max-w-md">
        The attempted action was detected and blocked by our security system. The attempt has been logged.
      </p>
      <Link
        href="/dashboard"
